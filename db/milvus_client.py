...
class MilvusParagraphClient:
    ...
    def __init__(
        self,
        collection_name: str = "anteproy_paragraphs",
    ...
    def _init_embedding_client(self, base_url: str):
        ...
        try:
            ...
            self.embedding_client.embeddings.create(
                model=self.embedding_model, input=["test"]
            )
    ...
    def _create_schema(self) -> CollectionSchema:
        ...
        fields = [
            ...
            FieldSchema(
                name="source", dtype=DataType.VARCHAR, max_length=20
            ),  # "paragraphs" or "preamble"
            ...
            FieldSchema(
                name="provision_block_id", dtype=DataType.VARCHAR, max_length=10
            ),
            FieldSchema(
                name="provision_block_title", dtype=DataType.VARCHAR, max_length=200
            ),
        ]
    ...
    def _get_metadata_for_paragraph(
        self, paragraph_id: str, metadata: Dict[str, Any]
    ) -> Dict[str, str]:
    ...
    def _get_provision_metadata_for_paragraph(
        self,
        paragraph_id: str,
        provisions: Dict[str, Any],
        provision_blocks: Dict[str, Any],
    ) -> Dict[str, str]:
    ...
    def insert_paragraphs(self):
        ...
        for content, embedding in zip(all_content, embeddings):
            ...
            # Get metadata
            metadata = self._get_metadata_for_paragraph(
                para_id,
                {
                    "books": books,
                    "titles": titles,
            ...
            record = {
                ...
                "provision_block_title": provision_metadata.get(
                ...
                for hit in hits:
                    result = {
                        ...
                        "metadata": {
                            ...
                            "provision_block_title": hit.entity.get(
                                "provision_block_title"
                            ),
                            # Rest of ids
                            ...
                            "provision_id": hit.entity.get("provision_id"),
                            "provision_block_id": hit.entity.get("provision_block_id"),
                        },
                    }
